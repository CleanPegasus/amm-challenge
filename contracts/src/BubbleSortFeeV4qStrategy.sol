...
/// @title BubbleSortFee V4q — decay=WAD/5, base=20bps (between WAD/4 and WAD/6)
contract Strategy is AMMStrategyBase {
    ...
    function getName() external pure override returns (string memory) { return "BubbleSortV4q"; }
}

...
/// @title BubbleSortFee V4s — decay=WAD/4, base=15bps (ultra-fast + ultra-low)
contract Strategy is AMMStrategyBase {
    ...
    uint256 public constant BASE_FEE = 15 * BPS;
    ...
    function afterInitialize(uint256, uint256) external override returns (uint256, uint256) {
        writeSlot(SLOT_SCALES + 0, 40 * BPS);
    ...
    function getName() external pure override returns (string memory) { return "BubbleSortV4s"; }
}

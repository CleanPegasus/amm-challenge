...
/// @title Proportional Spike V9 — Faster EMA + moderate settings
/// @notice 25bps base, alpha=20% (faster EMA, more responsive),
///         spike_scale=30bps, max=85bps, decay=10.
contract Strategy is AMMStrategyBase {
    uint256 public constant BASE_FEE = 25 * BPS;
    uint256 public constant SPIKE_SCALE = 30 * BPS;
    uint256 public constant MAX_SPIKE = 85 * BPS;

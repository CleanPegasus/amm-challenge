...
/// @title Proportional Spike-and-Decay Strategy
/// @notice Instead of a binary spike, the fee increase is proportional
///         to how much the trade size exceeds the EMA threshold.
///         spike_add = min(MAX_SPIKE, BASE_SPIKE * (size - threshold) / threshold)
///         This extracts more value from very large arb trades while being
///         gentler on marginally-large trades.
///
/// Slot layout:
...
contract Strategy is AMMStrategyBase {
    ...
    function afterSwap(TradeInfo calldata trade) external override returns (uint256, uint256) {
        ...
        // Proportional spike: scale with excess over threshold

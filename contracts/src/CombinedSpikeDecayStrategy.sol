...
/// @title Combined Spike-and-Decay Strategy
/// @notice Best-of-both: low 25bps base fee (undercut normalizer for retail)
///         + sensitive 1.5x EMA detection + slower decay (~12 step half-life).
///
/// Slot layout:

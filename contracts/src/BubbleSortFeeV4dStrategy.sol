...
/// @title BubbleSortFee V4d — scale=40, max=180 (same scale, much higher cap)
contract Strategy is AMMStrategyBase {
    ...
    uint256 public constant MAX_SPIKE = 180 * BPS;
    ...
    function getName() external pure override returns (string memory) { return "BubbleSortV4d"; }
}

...
/// @title BubbleSortFee V4f — scale=40, max=350
contract Strategy is AMMStrategyBase {
    ...
    uint256 public constant MAX_SPIKE = 350 * BPS;
    ...
    function getName() external pure override returns (string memory) { return "BubbleSortV4f"; }
}

...
/// @title Proportional Spike V10 — scale=40, max=120
/// @notice Pushing spike scale and max further.
contract Strategy is AMMStrategyBase {
    uint256 public constant BASE_FEE = 25 * BPS;
    uint256 public constant SPIKE_SCALE = 40 * BPS;

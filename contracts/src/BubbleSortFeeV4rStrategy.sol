...
/// @title BubbleSortFee V4r — decay=WAD/5, base=20, scale=45
contract Strategy is AMMStrategyBase {
    ...
    uint256 public constant DECAY_SPEED = WAD / 5;
    ...
    function getName() external pure override returns (string memory) { return "BubbleSortV4r"; }
}

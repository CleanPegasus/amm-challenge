...
/// @title BubbleSortFee V4k — scale=50, max=250 (re-test high scale with uncapped max)
contract Strategy is AMMStrategyBase {
    ...
    function getName() external pure override returns (string memory) { return "BubbleSortV4k"; }
}

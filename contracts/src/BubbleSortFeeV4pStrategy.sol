...
/// @title BubbleSortFee V4p — decay=WAD/6, base=15bps (aggressive undercut)
contract Strategy is AMMStrategyBase {
    ...
    uint256 public constant DECAY_SPEED = WAD / 6;
    ...
    function getName() external pure override returns (string memory) { return "BubbleSortV4p"; }
}

...
/// @title Proportional Spike V6 — Very low base (20bps)
/// @notice Extreme undercut of normalizer at 20bps base with strong spike protection.
contract Strategy is AMMStrategyBase {
    uint256 public constant BASE_FEE = 20 * BPS;
    uint256 public constant SPIKE_SCALE = 30 * BPS;
    uint256 public constant MAX_SPIKE = 80 * BPS;

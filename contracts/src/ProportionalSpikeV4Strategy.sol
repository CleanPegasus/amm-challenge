...
/// @title Proportional Spike V4 — Slower decay + higher scale
/// @notice Same 1.5x threshold but slower decay (half-life ~12 steps),
///         higher spike scale (30bps), and max 70bps.
///
/// Slot layout:

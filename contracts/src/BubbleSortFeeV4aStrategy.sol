...
/// @title BubbleSortFee V4a — scale=50, max=150
contract Strategy is AMMStrategyBase {
    ...
    uint256 public constant MAX_SPIKE = 150 * BPS;
    ...
    function getName() external pure override returns (string memory) { return "BubbleSortV4a"; }
}

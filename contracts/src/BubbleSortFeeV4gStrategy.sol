...
/// @title BubbleSortFee V4g — scale=40, max=500 (near MAX_FEE cap)
contract Strategy is AMMStrategyBase {
    ...
    uint256 public constant MAX_SPIKE = 500 * BPS;
    ...
    function getName() external pure override returns (string memory) { return "BubbleSortV4g"; }
}

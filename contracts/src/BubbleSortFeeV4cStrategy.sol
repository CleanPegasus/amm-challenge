...
/// @title BubbleSortFee V4c — scale=45, max=140 (moderate push)
contract Strategy is AMMStrategyBase {
    ...
    uint256 public constant MAX_SPIKE = 140 * BPS;
    ...
    function getName() external pure override returns (string memory) { return "BubbleSortV4c"; }
}
